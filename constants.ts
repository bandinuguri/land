...
export const CASES: Case[] = [
  {
    ...
    date: "2024.08.21",
    images: [
      { url: "image/best_01_01.png", label: "사고현장" },
      { url: "image/best_01_02.png", label: "사고장비" }
    ],
    ...
    footerImages: [
      { url: "image/best_01_03.png", label: "장비결박로프 제작" },
      { url: "image/best_01_04.png", label: "장비결박로프 시현" }
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    date: "2024.05.14",
    images: [
      { url: "image/best_03_01.png", label: "개선 전 (위험 상황)" },
      { url: "image/best_03_02.png", label: "개선 후 (안전 확보)" }
    ],
  ...
  },
  {
    ...
    effect: "비행 중 패널 탈락 및 연료 누출 등 2차 대형 사고를 미연에 방지함"
  },
  {
    id: 6,
    type: CaseType.EXCELLENCE,
    title: "주기장 FOD 실시 중 타사 차량 이상 발견 및 초기 진화 조치",
    company: "아시아나에어포트",
    airport: "인천공항",
    date: "2022.05.23",
    content: "'22.05.23(월) 항공기 진입 전 주기장 FOD(이물질 제거) 작업 중, 이동 중인 타사 Tug Car의 Dolly 뒷바퀴가 이탈되며 마찰로 인한 불꽃과 연기가 발생하는 것을 목격하고 즉시 대응함.",
    cause: ["타사 조업장비의 기계적 결함(바퀴 이탈)"],
    countermeasure: [
      "현장 조업장비 내 소화기 상시 비치 및 점검",
      "주변 장비에 대한 상시 감시 체계 유지 및 비상 대응 절차 숙달"
    ],
  ...
  },
  {
    ...
    date: "2024.11.25",
    images: [
      { url: "image/best_07_01.png", label: "개선 전/후 조업 환경" }
    ],
